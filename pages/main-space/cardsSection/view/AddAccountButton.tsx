	...
	return (<>
		<div className={'flex flex-col flex-grow'}>
			<TextField
				...
				onInput={setName}
				style={'simple'}
				inputClass='bg-transparent leading-5 font-bold text-xl text-slate-900 font-sans'
				placeholder='Tinkof'
			/>
			<div className='flex items-center leading-5 pl-2.5 text-slate-700'>
				<span className='mr-1'>Balance:</span>
				<TextField
					value={balance}
					onInput={onBalanceInput}
					style='simple'
					inputClass='bg-transparent leading-5 text-slate-900 font-sans'
					placeholder='0'
				/>
			</div>
		</div>
